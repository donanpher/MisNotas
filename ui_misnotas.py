...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.labelTitulo.setGeometry(QtCore.QRect(20, 10, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        ...
        self.line.setGeometry(QtCore.QRect(19, 35, 500, 10))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(30, 40, 241, 17))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        font.setPointSize(8)
        ...
        self.label_3.setGeometry(QtCore.QRect(23, 87, 110, 17))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        font.setPointSize(10)
        ...
        self.pushButtonGuardar.setGeometry(QtCore.QRect(20, 142, 101, 29))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.tableWidgetNotas.setGeometry(QtCore.QRect(20, 190, 491, 192))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        font.setPointSize(10)
        ...
        self.tableWidgetNotas.setColumnCount(3)
        ...
        self.pushButtonModificar.setGeometry(QtCore.QRect(19, 395, 101, 29))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButtonEliminar.setGeometry(QtCore.QRect(148, 395, 101, 29))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButtonSalir.setGeometry(QtCore.QRect(410, 396, 101, 29))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.labelResponse.setGeometry(QtCore.QRect(26, 430, 481, 20))
        self.labelResponse.setText("")
        self.labelResponse.setAlignment(QtCore.Qt.AlignCenter)
        self.labelResponse.setObjectName("labelResponse")
        self.labelID = QtWidgets.QLabel(Dialog)
        self.labelID.setGeometry(QtCore.QRect(30, 110, 67, 17))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "v.1.0"))
